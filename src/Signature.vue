<template>
  <div>
    ...
    <div ref="raw" v-show="false">
        ...
        <mj-body>
            <mj-section padding="20px 18px" text-align="left">
                <mj-column vertical-align="middle" width="120px" padding="0">
                ...
                <mj-column vertical-align="middle" padding="0px 0px 0px 20px">
                    ...
                    <mj-text padding="0px"  color="#1b1b1f" font-size="10px" line-height="16px" font-weight="400" font-family="Poppins">{{ getPhoneLabelForLang(language) }} <a style="color: #1b1b1f !important; text-decoration: none !important;" href="tel:+3292964012">+32 9 296 40 12</a></mj-text>
            ...
            <mj-section padding="18px">
                <mj-wrapper background-color="#f5f6fe" padding="16px 24px" border-radius="8px">
                    <mj-table>
                        <tr>
                            <td>
